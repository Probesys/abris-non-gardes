...
class DysfonctionnementFilterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
              ...
              ->add('natureDys', EntityType::class, [
                  'label' => 'Entities.Dysfonctionnement.fields.natureDys',
                ...
                ->add('statusDys', EntityType::class, [
                        'label' => 'Entities.Dysfonctionnement.fields.statusDys',
                        'class' => ListingValue::class,
                        'expanded' => false,
                        'required' => false,
                        'multiple' => false,
